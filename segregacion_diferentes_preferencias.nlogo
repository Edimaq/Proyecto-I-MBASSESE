...
to setup
  ...
  create-turtles ((world-width * world-height) * densidad) [
...
to-report soy_feliz?
  ...
  ifelse (num_vecinos_grupo >= num_vecinos * preferencia_1 / 100) and (num_vecinos_grupo >= num_vecinos * preferencia_2 / 100)
  [ report true ]
  [ report false ]
end
@#$#@#$#@
